import 'package:fasting_hell/screens/screen_template.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../constants/colors.dart';
import '../controller/fasting_plan_controller.dart';
import 'fasting_countdown_screen.dart';
import 'fasting_save_screen.dart';
import 'get_ready_screen.dart';

class FastingPlanScreen extends StatelessWidget {
  static const String routeName = '/fastingPlanScreen';
  FastingPlanScreen({Key? key}) : super(key: key);
  ...
  Future<bool> _fetchData() async {
    try {
      await controller.fetchDataFastingHistory();
